...
const Item: React.FC<ItemProps> = ({ increment, decrement, quantity, itemName }) => {
  ...
  return (
    <div className="item bg-light-green-200 pt-2 flex justify-between items-center border-b border-gray-200 hover:bg-green-100">
      ...
      <div className="flex items-center">
        ...
        {decrement && (
          <button className="px-3 py-1 bg-red-500 rounded-md" onClick={decrementItem}>
            -
          </button>
        )}
        ...
        {increment && (
          <button className="px-3 py-1 bg-green-700 rounded-md" onClick={incrementItem}>
            +
          </button>
        )}
      </div>
