...
const ArrowButton = (props: ArrowButtonProps) => {
  ...
  if (props.direction === "right") {
    return (
      <button
        onClick={handleClick}
        className="px-5 py-2 rounded-3xl hover:bg-green-700 group"
      >
        <svg
          width="40"
          height="40"
